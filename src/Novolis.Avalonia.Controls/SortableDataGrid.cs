...
/// <summary>Data grid tuned for high-volume tabular rows.</summary>
public sealed class SortableDataGrid : DataGrid
{
    /// <summary>Creates a read-only, sortable data grid with standard grid chrome.</summary>
